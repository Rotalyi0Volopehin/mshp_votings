...
class RegistrationForm(forms.Form):
    ...
    name = forms.CharField(label="Имя", min_length=1, max_length=64, required=True, widget=forms.NumberInput(attrs={
        'class': 'form-control',
        'type': 'text',
        'placeholder': 'Enter name'
    }))
    email = forms.EmailField(label="E-mail", min_length=1, max_length=64, required=True,
                             widget=forms.NumberInput(attrs={
                                 'class': 'form-control',
                                 'type': 'email',
